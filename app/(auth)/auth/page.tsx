 ...
 return ( 
  <div className="flex min-h-screen mt-7">
    <div className="w-full max-w-3xl mx-auto flex flex-col lg:flex-row p-3">
      ...
      {/* Form header */}
      <div>
        <h2 className='text-3xl sm:text-4xl lg:text-5xl font-bold-medium mb-4 sm:mb-6 bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 bg-clip-text text-transparent pb-3'>
          {isSignUp ? 'Sign Up' : 'Sign In'}
        </h2>
        <p className='text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8'>
          {isSignUp
            ? 'Join NikoStore today and discover exclusive deals on your favorite products!'
            : 'Welcome back to NikoStore! Log in to continue your shopping journey.'}
        </p>
      </div>
